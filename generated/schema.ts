...
export class EventList extends Entity {
  ...
  get roundstate(): string | null {
    let value = this.get("roundstate");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toString();
  ...
  set roundstate(value: string | null) {
    if (!value) {
      this.unset("roundstate");
    } else {
      this.set("roundstate", Value.fromString(<string>value));
    }
  }

  get newround(): string | null {
  ...
  set newround(value: string | null) {
    if (!value) {
      this.unset("newround");
    } else {
      this.set("newround", Value.fromString(<string>value));
    }
  }

  get completeproposal(): string | null {
    let value = this.get("completeproposal");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toString();
  ...
  set completeproposal(value: string | null) {
    if (!value) {
      this.unset("completeproposal");
    } else {
      this.set("completeproposal", Value.fromString(<string>value));
    }
  }
  ...
  get blocksyncstatus(): string | null {
    let value = this.get("blocksyncstatus");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toString();
  ...
  set blocksyncstatus(value: string | null) {
    if (!value) {
      this.unset("blocksyncstatus");
    } else {
      this.set("blocksyncstatus", Value.fromString(<string>value));
    }
  }

  get statesyncstatus(): string | null {
    let value = this.get("statesyncstatus");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toString();
  ...
  set statesyncstatus(value: string | null) {
    if (!value) {
      this.unset("statesyncstatus");
    } else {
      this.set("statesyncstatus", Value.fromString(<string>value));
    }
  }
}
...
export class EventRoundState extends Entity {
  ...
  set step(value: string | null) {
    if (!value) {
      ...
      this.set("step", Value.fromString(<string>value));
    }
  }
}
...
export class ValidatorInfo extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ValidatorInfo entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ValidatorInfo entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("ValidatorInfo", id.toString(), this);
    }
  }

  static load(id: string): ValidatorInfo | null {
    return changetype<ValidatorInfo | null>(store.get("ValidatorInfo", id));
  }
