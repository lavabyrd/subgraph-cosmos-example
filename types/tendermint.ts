...
export namespace tendermint {
	...
	export class EventList {
		public newblock: EventDataNewBlock
 		public transaction: Array<EventDataTx>
 		public vote: EventDataVote
 		public roundstate: EventDataRoundState
 		public newround: EventDataNewRound
 		public completeproposal: EventDataCompleteProposal
 		public validatorsetupdates: EventDataValidatorSetUpdates
 		public eventdatastring: EventDataString
 		public blocksyncstatus: EventDataBlockSyncStatus
 		public statesyncstatus: EventDataStateSyncStatus

		constructor(
			newblock: EventDataNewBlock,
			transaction: Array<EventDataTx>,
			vote: EventDataVote,
			roundstate: EventDataRoundState,
			newround: EventDataNewRound,
			completeproposal: EventDataCompleteProposal,
			validatorsetupdates: EventDataValidatorSetUpdates,
			eventdatastring: EventDataString,
			blocksyncstatus: EventDataBlockSyncStatus,
			statesyncstatus: EventDataStateSyncStatus,
		) {
			...
			this.completeproposal = completeproposal;
			this.validatorsetupdates = validatorsetupdates;
			this.eventdatastring = eventdatastring;
			this.blocksyncstatus = blocksyncstatus;
			this.statesyncstatus = statesyncstatus;
		}
	}

	export class EventDataNewBlock {
		public block: Block
	...
	export class EventDataNewBlockHeader {
		public header: Header
 		public num_txs: i64
 		public result_begin_block: ResponseBeginBlock
 		public result_end_block: ResponseEndBlock
	...
	export class DuplicateVoteEvidence {
		public vote_a: EventDataVote
 		public vote_b: EventDataVote
 		public total_voting_power: i64
 		public validator_power: i64
 		public timestamp: Timestamp

		constructor(
			vote_a: EventDataVote,
			vote_b: EventDataVote,
	...
	export class EventDataRoundState {
		public height: u64
 		public round: i32
 		public step: string
	...
	export class EventDataNewRound {
		public height: u64
 		public round: i32
 		public step: string
 		public proposer: ValidatorInfo
	...
	export class EventDataValidatorSetUpdates {
		public validator_updates: Array<Validator>
	...
	export class EventDataString {
		public eventdatastring: string
	...
	export class EventDataBlockSyncStatus {
	...
	export class EventDataStateSyncStatus {
		public complete: bool
 		public height: u64
